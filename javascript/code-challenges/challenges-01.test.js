...
const allUpperCase = arr => {
  ...
  let upperCase = []
  arr.forEach(str => {
    let upperResult = str.toUpperCase()
    upperCase.push(upperResult)
  })
  return upperCase
}
...
const greeting = word => {
  // Solution code here...
  let greetingResult = word.toUpperCase() + '!'
...
const createList = availableItems => {
  ...
  availableItems.forEach(listItem=>{
    if(listItem.available){
      groceryList.push(listItem.name);
    }
  })
  return groceryList;
}
