...
Write a function named longestString that takes in an array of strings and returns the index position of the longest string.  If array is empty, return -1.
------------------------------------------------------------------------------------------------ */
...
const standardizePhoneNumbers = arr => {
  ...
  let numbers = [];
  for (let i = 0; i < arr.length; i++) {
    numbers.push(arr[i].replace(/[^0-9]/g, ''));
  }
  return numbers;
