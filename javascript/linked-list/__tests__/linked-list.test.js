...
it ('should append a node to the end of the linked list', () => {
  ...
  expect (linked.toString ()).toEqual (
    '{apple} -> {banana} -> {carrot} -> NULL'
  );
});
...
it ('should append multiple nodes to the end of the linked list', () => {
  ...
  expect (linked.toString ()).toEqual (
    '{apple} -> {banana} -> {carrot} -> {date} -> {eggplant} -> NULL'
  );
});
...
it ('should insert a node before the first node of a linked list', () => {
  ...
  expect (linked.toString ()).toEqual (
    '{cherry} -> {apple} -> {banana} -> {carrot} -> {date} -> {eggplant} -> NULL'
  );
});
...
it ('should insert after a node after the first node', () => {
  ...
  expect (linked.toString ()).toEqual (
    '{apple} -> {strawberry} -> {banana} -> {carrot} -> {date} -> {eggplant} -> NULL'
  );
});
...
it ('zip two linked lists together', () => {
  ...
  let result = linkedList1.zipLists (linkedList1, linkedList2);
